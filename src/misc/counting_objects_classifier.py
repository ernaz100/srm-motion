...
from src.dataset.dataset_counting_polygons.labelers import (
...
class CountingObjectsClassifierWrapper:
    def __init__(
        self,
...
@cache
def get_counting_objects_classifier(
    *args, **kwargs
) -> CountingObjectsClassifierWrapper:
    return CountingObjectsClassifierWrapper(*args, **kwargs)
